...
<head>
  ...
  <meta property="og:url" content="http://lightningthunder.github.io/index.html" />
  ...
  <div class="container-fluid la_home-hero">
    ...
    <div class="row la_home-hero-wrapper center-block vertical-center">
      ...
      <div class="col-xs-12 col-lg-12 form-group home_country required">
        ...
        <button onclick="window.location.href='results.html'" class="btn btn-default btn-primary btn-search-now center-block">
          ...
          <div id="promo-carousel" class="carousel slide" data-interval="600000" data-ride="carousel" data-pause="hover">
            <!-- Carousel indicators -->
              ...
              <div class="carousel-inner card">
                  <div onclick="window.location.href='details.html'" class="active item" id="day0001">
                    <div class="slideshow">
    ...
    <div class="row promo external-asset">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="content ext-ad-banner clearfix">
          ...
          <div class="col-xs-12 col-sm-12 col-md-4 clearfix form-group ext-ad-ais required">
            <input class="form-control" size="4" type="tel" placeholder="Enter your 10 digit number">
            <button class="btn btn-default btn-primary btn-ext-ad-ais">
              Generate Code
            </button>
          </div>
    ...
    <div class="row promo deals">
      <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
        <div class="content la_hot-deals">
          ...
          <a href="results.html" class="btn btn-primary btn-sm">View all Chiang Mai tours</a>
        </div>
      </div>
