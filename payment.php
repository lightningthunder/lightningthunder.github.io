...
<head>
  ...
  <link rel="stylesheet" href="css/la_payment.css">
...
<body>
  ...
  <div class="container-fluid payment-top-hero">
    <div class="row padding-bottom-20">
      ...
      <!-- This is teddy bear header -->
      <div class="text-center booking-teddy-bear">
        <h1 class="text-center">
          Congrats! Your booking request is available.
        </h1>
        <ul>
          <li><span class="glyphicon glyphicon-flash"></span>
          <span>Instant Booking</span></li>
    ...
    <div class="row">
      <div class="col-xs-12 add-ons" id="la_add-ons">
        <div class="col-xs-12 text-center">
          <h2>Fancy some upgrades?</h2>
          <p class="lead">Add one of these hand-picked upgrades to enhance your travel experience.</p>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 text-center padding-top-20">
          <div class="card add-ons text-center">
            <div class="slideshow">
            ...
            <div class="header">
              <h4>Private Toyota van pick up and drop off</h4>
            </div>
            <div class="content">
              ...
              <div class="footer">
                <div class="add-ons-cap clearfix">
                  <span class="add-ons-cap-pax">
                    Fits 9 travelers
                  </span>
                </div>
                <div class="add-ons-cost clearfix">
                  <span class="add-ons-cost-price">2500 THB</span>
                  <span class="add-ons-cost-unit">per van</span>
                </div>  
              </div>
            </div>
          </div>
          <button class="btn btn-primary btn-sm btn-add-to-trip"><i class="fa fa-plus-circle"></i> Add to trip</button>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 padding-top-20 text-center">
          <div class="card add-ons text-center">
            <div class="slideshow">
            ...
            <div class="content">
              ...
              <div class="footer">
                <div class="add-ons-cap clearfix">
                  <span class="add-ons-cap-pax">
                    Good for 10 travelers
                  </span>
                </div>
                <div class="add-ons-cost clearfix">
                  <span class="add-ons-cost-price">1500 THB</span>
                  <span class="add-ons-cost-unit">per show</span>
                </div>  
              </div>
            </div>
          </div>
          ...
          <div class="card add-ons text-center">
            ...
            <div class="content">
              ...
              <div class="footer">
                ...
                <div class="add-ons-cost clearfix">
                  <span class="add-ons-cost-price">500 THB</span>
                  <span class="add-ons-cost-unit">per traveler</span>
                </div>  
              </div>
            </div>
          </div>
  ...
  <div class="container">
    <div class="row" style="margin-top: 100px;">
      ...
      <div class="col-xs-12 col-md-4 col-md-push-8">
        <div class="card booking-summary" id="sidebar">
          <h3 class="text-center">Your Booking Summary</h3>
          <h2 class="item_name text-center" max-char="45">Immersive Local Living in the Valley of Chiang Mai</h2>

          <div class="col-xs-12 col-lg-12">
            <ul class="summary-list list-unstyled clearfix">
              <li>
                <span class="item">Base price (7200 x 2 travelers)</span>
                <span class="value-price">14400</span>
              </li>
              <li>
                <span class="item additional">Private van x 1</span>
                <span class="value-price">2400</span>
              </li>
              <li>
                <span class="item additional">Advanced cooking class x 2</span>
                <span class="value-price">400</span>
              </li>
              <li>
                <span class="item additional">Lanna cultural dance x 1</span>
                <span class="value-price">1500</span>
              </li>

              <li class="subtotal">
                <span class="item total"></span>
                <span class="value-price">18700</span>
              </li>

              <li class="discount">
                <span class="item discount">AIS Traveller SIM discount (10%)</span>
                <span class="value-price">-1870</span>
              </li>

              <li>
                <span class="item additional">Value added tax (7%)</span>
                <span class="value-price">1178</span>
              </li>

              <li class="grandtotal">
                <span class="item grandtotal">(After taxes)</span>
                <span class="value-price">18008</span>
              </li>

            </ul>
            <div class="polar-bear clearfix">
              <div class="col-xs-12 col-lg-12">
              ...
              <div class="col-xs-12 col-lg-6">
                <p class="item_operator">Bangkok Vanguards</p>
              </div>
              <div class="col-xs-12 col-lg-6">
                <p class="item_starts">2 June 1990</p>
              </div>
              <div class="col-xs-12 col-lg-6">
                <p class="item_ends">4 June 1990</p>
              </div>
            </div>
            <ul class="read-list list-unstyled text-center">
              <li><a>Read our cancellation policy</a></li>
              <li><a>Read about our terms and condition</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <form action="/checkout" method="post" class="col-xs-12 col-md-8 col-md-pull-4" id="la_checkout">
        <div class="card booking-payment payment">
          ...
          <div class="form-row clearfix">
            ...
            <div class="col-xs-12 col-lg-6 form-group card-number required">
              ...
              <div class="select-block">
                <select name="payment-type" placeholder="Select">
                  <option value="cc">Credit card (VISA or Master Card)</option>
          ...
          <div class="form-row clearfix">
            ...
            <div class="col-xs-12 col-lg-6 form-group card-number required">
             ...
             <!-- <div class="form-row">
              <div class="col-xs-12 form-group billing-address required">
        ...
        <!-- these are add-ons -->
        <!-- <div class="card booking-add-ons add-ons">
          <hr>
        ...
        <!-- tips and notes -->
        <!-- <div class="col-xs-12 additional-list">
          <h4>Tips and Notes</h4>
          <ul>
            <li>Community based tourism is highly flexible and these are merely suggested things to do. Talk to us and let us know how we can help you craft your once-in-a-lifetime experience at Mae Kampong.</li>
            <li>Mae Kampong is open all year. Tea harvesting happens between May to November. This community gets very lively during Thai holidays like Songkran or New Year and may not be suitable for those seeking a quiet getaway.</li>
            <li>These are suggested activities within the community. The guideline itinerary can be subject to change or switch due to weather, access, local events, guests' fitness and time management. Substitute indoor activities will be provided if the main outdoor activities cannot run properly</li>
            <li>All additional activities are not included in the standard package price. Additional cost as listed below will be charged at location.</li>
      ...
      $(window).scroll(function () {
          ...
          if (currentScroll > headerOrgOffset) {
              if (currentScroll > previousScroll) {
                  $('#global-header-wrap').css('top','-51px');
              } else {
